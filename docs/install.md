...
[v0.4.0-alpha release](https://github.com/pixelrhino-ai/vrhino/releases/tag/v0.4.0-alpha):

- `vrhino-linux-x86_64-cuda-v0.4.0-alpha.tar.gz`
- `vrhino-linux-x86_64-cuda-v0.4.0-alpha.tar.gz.sha256`
