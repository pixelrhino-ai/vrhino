...
public:
    ...
    Tensor copy_to_device(const Tensor&, DType) override;
    Tensor copy_to_host(const Tensor&) override;
    ...
    void enable_profiling(bool) override;
    ...
    void enable_weight_cache(bool) override;
    void enable_true_quant_compute(bool) override;
